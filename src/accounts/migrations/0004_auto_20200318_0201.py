...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('accounts', '0003_auto_20200318_0012'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user', to='accounts.EducationInfo')),
